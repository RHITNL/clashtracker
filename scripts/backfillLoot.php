...
foreach ($goldDates as $i => $date) {
	$goldDates[$i] = date('Y-m-d H:i:s', strtotime($date . " 20:00:00"));
}
...
foreach ($elixirDates as $i => $date) {
	$elixirDates[$i] = date('Y-m-d H:i:s', strtotime($date . " 20:00:00"));
}
...
foreach ($darkElixirDates as $i => $date) {
	$darkElixirDates[$i] = date('Y-m-d H:i:s', strtotime($date . " 20:00:00"));
}
