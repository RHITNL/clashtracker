...
<div id="showChangePasswordButton" class="col-xs-2 col-sm-4 col-md-6 col-lg-8">
	<button type="button" class="btn btn-xs btn-primary" onclick="showChangeEmailDiv();">Change</button>
</div>
<div class="container">
